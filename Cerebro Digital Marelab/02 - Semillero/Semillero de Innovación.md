---
tags: [semillero, innovación, ideas, validación]
created: 2026-04-12
tipo: moc
---
...
```mermaid
flowchart TD
    A[💡 Idea en Baúl] --> B{¿Tiene problema\nclear?}
    B -- No --> C[Volver al Baúl\ny definir mejor]
    B -- Sí --> D[Crear LC en Semillero]
    D --> E[Completar los 9 bloques\ndel Lean Canvas]
    E --> F{¿Tiene sentido\nel negocio?}
    F -- No --> G[Archivar con\naprendizaje]
    F -- Sí --> H[Crear/Actualizar\nBMC]
    H --> I[Definir Propuesta\nde Valor validada]
    I --> J[Pasar a Ejecución\nRoadmap + SOPs]
```
